...
window.$ = window.jQuery = function (selectorOrArrayOrTemplate) {
  ...
  return {
    jquery: true,
    // 这个属性表示正在处理的某个（或某些）元素节点是经过jquery处理的，那么这个元素节点是一个数组，在处理的时候要get(0)取得第0个
    elements: elements,
    ...
    appendTo: function appendTo(node) {
      ...
      if (node instanceof Element) {
        // Element是一个基类，所有document对象下的属性都继承Element（也就是通过原生dom => document.xxxxx 得到的DOM对象都属于这类）
    ...
    append: function append(children) {
      ...
      if (children instanceof Element) {
        ...
        // HTMlCollection是表示一种成员为Element的通用集合。
    ...
    children: function children() {
      var array = [];
      this.each(function (node) {
        array.push.apply(array, _toConsumableArray(node.children)); // 展开二元数组中的每一项
      });
      return jQuery(array);
    },
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10792" + '/');
...
},{}]},{},["C:/Users/yeah!/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","jquery.js"], null)
